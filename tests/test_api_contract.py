...
EXPECTED_SIGNATURES = {
    ...
    "weapon_attack": "(weapon: 'str | dict', *, strength_mod: 'int' = 0, dexterity_mod: 'int' = 0, proficiency_bonus: 'int' = 0, proficient: 'bool' = True, two_handed: 'bool' = False, attack_bonus: 'int' = 0, damage_bonus: 'int' = 0, weapons: 'list[dict] | None' = None) -> 'WeaponAttack'",
...
EXPECTED_MODEL_FIELDS = {
    ...
    "ClassMechanics": ["archetype", "armor_proficiencies", "hit_die", "progression",
                       "resource_mechanic", "saving_throw_proficiencies",
                       "skill_proficiency_count", "skill_proficiency_options",
